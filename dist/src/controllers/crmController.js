...
var crmModel_js_1 = require("../models/crmModel.js");
var Contact = mongoose_1.default.model('Contact', crmModel_js_1.ContactSchema);
var addNewContact = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newContact, contact, error_1;
...
var getContactWithID = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var contact, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Contact.findById(req.params.contactId)];
            case 1:
                contact = _a.sent();
                res.json(contact);
                return [3 /*break*/, 3];
...
var updateContact = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Contact.findOneAndUpdate({ _id: req.params.contactId }, req.body, { new: true })];
            case 1:
                contact = _a.sent();
                res.json(contact);
                return [3 /*break*/, 3];
...
var deleteContact = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Contact.deleteOne({ _id: req.params.contactId })];
            case 1:
                _a.sent();
